...
(function () {
    ...
    Object.prototype.clone = function () {
        ...
        for (var i in this) {
            ...
            if (this[i] && _typeof(this[i]) == "object") {
...
game.prototype = {
    ...
    buildPieces: function buildPieces() {
    ...
    endLevel: function endLevel(isWin) {
        /*
    ...
    playAudio: function playAudio(id, vol) {
        /*
    ...
    piece: function piece(val, id, name) {
        /*
