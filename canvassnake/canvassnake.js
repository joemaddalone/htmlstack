...
if (window.HTMLCanvasElement) {
    ...
    var game = (_game = {
        ...
        blockSize: 10
    }, _defineProperty(_game, 'width', 500), _defineProperty(_game, 'height', 300), _defineProperty(_game, 'items', {
        apple: {
    ...
    }), _defineProperty(_game, 'player', {
        score: 0
    }), _defineProperty(_game, 'img', function img(s) {
        var me = new Image();
        me.src = s;
        return me;
    }), _defineProperty(_game, 'hit', function hit(o1, o2) {
        return o1.x == o2.x && o1.y == o2.y;
    }), _defineProperty(_game, 'cannibal', function cannibal(e, i) {
        return i < game.items.snake.size - 1 && game.items.snake.x == e[0] && game.items.snake.y == e[1];
    }), _defineProperty(_game, 'play', function play() {
        ...
        game.showScore();
    }), _defineProperty(_game, 'showScore', function showScore() {
        game.ctx().font = '90px sans-serif';
        game.ctx().fillStyle = 'rgba(0, 0, 0, 0.10)';
        game.ctx().fillText(game.player.score, 10, 255);
    }), _defineProperty(_game, 'place', function place(o) {
        game.ctx().drawImage(o.obj, o.x, o.y);
    }), _defineProperty(_game, 'findplace', function findplace(o) {
    ...
    }), _defineProperty(_game, 'clearboard', function clearboard() {
        game.ctx().clearRect(0, 0, game.canvas().width, game.canvas().height);
    }), _defineProperty(_game, 'clearitem', function clearitem(o) {
        game.ctx().clearRect(o.x, o.y, game.blockSize, game.blockSize);
        o.x = -10, o.y = -10;
    }), _defineProperty(_game, 'start', function start() {
    ...
    }), _defineProperty(_game, 'wait', function wait() {
        game.clearboard();
    ...
    }), _defineProperty(_game, 'stop', function stop() {
        window.clearInterval(game._interval);
        game.running = false;
        game.clearitem(game.items.apple);
        game.clearboard();
