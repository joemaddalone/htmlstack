...
var game = {
    ...
    items: {
		...
		poster: {image:'poster.gif',x:0,y:0,obj:{}}
    },
    player: {
        score: 0
    },
    ...
    play: function () {
		...
		if(game.items.snake.size==1){game.player.score=0}
	...
	place: function(o){game.ctx().drawImage(o.obj, o.x, o.y)},
	...
	clearboard: function(){game.ctx().clearRect(0, 0, game.canvas().width,game.canvas().height);},
...
} else {document.getElementById('container').innerHTML="<h1>Your browser does not support canvas.</h1>"}
