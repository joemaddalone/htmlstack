...
player.prototype = {
  video: function (v, file) {
    ...
    v = ce("video", "v"); //v.setAttribute('controls', 'true');
  ...
  make: function () {
    ...
    this.vscrub = new this.drawControl("videoScrubber", 0, 20, this.root_bg); //this.fscr = new this.drawControl("fscr", 50, 20,this.root_bg)

    this.fillControl(this.vol);
    this.fillControl(this.playButton);
    this.fillControl(this.vscrub); //this.fillControl(this.fscr)
    ...
    controls.appendChild(this.vol); //controls.appendChild(this.fscr);
  ...
  resizeVideo: function () {
    var aspect = this.vid.videoHeight / this.vid.videoWidth; //original height / original width x new width = new height
    ...
    this.vscrub.width = this.c.width * 0.75; //this.fscr.width = this.c.width * 0.15
  ...
  drawFrame: function () {
    if (this.c) {
      ...
      this.c.ctx.drawImage(_("v"), (this.c.width - this.arW) / 2, (this.c.height - this.arH) / 2, this.arW, this.arH); //this.drawProgress(this.vscrub)
  ...
  destroy: function () {
    if (_("v") != null) {
      ...
      _("videoScrubber").parentNode.removeChild(_("videoScrubber")); //_("fscr").parentNode.removeChild(_("fscr"));
